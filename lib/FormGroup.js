...
var FormGroup = function (_React$Component) {
    ...
    _createClass(FormGroup, [{
        ...
        value: function render() {
            ...
            var formText = errorMessage || helpText;

            if (formText) {
                helpBlock = _react2.default.createElement(
                    "p",
                    { className: (0, _classnames2.default)("form-group", errorMessage ? "invalid-feedback" : "text-muted") },
                    formText
                );
            }
            ...
            return _react2.default.createElement(
                "div",
                { className: (0, _classnames2.default)("form-group", horizontal ? "form-row" : null, errorMessage && "has-error") },
                labelElement,
                horizontal ? _react2.default.createElement(
                    "div",
