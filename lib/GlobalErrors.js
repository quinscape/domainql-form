        ...
        if (Array.isArray(value)) {
            ...
            for (var propName in value) {
                if (value.hasOwnProperty(propName)) {
                    var _e = value[propName];

                    pushErrors(errorList, _e, name + "." + propName, form);
                }
            }
        }
    } else {
...
var GlobalErrors = function (_React$Component) {
    ...
    function GlobalErrors() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GlobalErrors.__proto__ || Object.getPrototypeOf(GlobalErrors)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(GlobalErrors, [{
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
            ...
            var nextErrors = nextProps.formConfig.formikProps.errors;
            ...
            var errorList = GlobalErrors.linearizeErrors(nextErrors, null);
