...
var Field = function (_React$Component) {
    ...
    _createClass(Field, [{
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
            ...
            if (fieldContext && fieldContext.id === id && fieldContext.name === name && fieldContext.label === label && fieldContext.placeHolder === placeHolder && fieldContext.inputClass === inputClass) {
                if (prevState.fieldContext.labelClass === labelClass) {
                    // yes -> no update
