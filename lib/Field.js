...
var Field = function (_React$Component) {
    ...
    function Field() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Field.__proto__ || Object.getPrototypeOf(Field)).call.apply(_ref, [this].concat(args))), _this), _this.onChange = function (ev) {
            ...
            var fieldContext = _this.state.fieldContext;
    ...
    _createClass(Field, [{
        ...
        value: function render() {
            ...
            if (typeof children === "function") {
                ...
                var renderFn = _GlobalConfig2.default.getRenderFn(formConfig, fieldContext);
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
            var id = nextProps.id,
                ...
                inputClass = nextProps.inputClass,
                labelClass = nextProps.labelClass,
            ...
            var fieldContext = prevState.fieldContext;


            if (fieldContext && fieldContext.effectiveMode === effectiveMode && fieldContext.placeholder === placeholder && fieldContext.inputClass === inputClass && fieldContext.labelClass === labelClass && fieldContext.tooltip === tooltip) {
                // yes -> no update
            ...
            var validation = formConfig.options.validation;
...
exports.default = (0, _withFormConfig2.default)((0, _mobxReact.observer)(Field));