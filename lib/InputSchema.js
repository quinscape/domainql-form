...
function resetConverter() {
    converter = _extends({}, _defaultConverters2.default);
}
...
var InputSchema = function () {
    function InputSchema(schema) {
        ...
        var tracking = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    _createClass(InputSchema, [{
        ...
        value: function getType(typeName) {
            ...
            var domainType = findNamed(types, typeName);

            if (this.tracking && domainType != null && !this.typesUsed.has(typeName)) {
