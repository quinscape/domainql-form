...
var TextArea = function (_React$Component) {
    ...
    function TextArea() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TextArea.__proto__ || Object.getPrototypeOf(TextArea)).call.apply(_ref, [this].concat(args))), _this), _this.renderWithFieldContext = function (formConfig, fieldContext) {
            var _this$props = _this.props,
                rows = _this$props.rows,
                cols = _this$props.cols,
                inputClass = _this$props.inputClass;
            var fieldId = fieldContext.fieldId,
                ...
                fieldInstance = fieldContext.fieldInstance,
            ...
            var isPlainText = mode === _FieldMode2.default.PLAIN_TEXT;
            ...
            return _react2.default.createElement(
                ...
                isPlainText ? _react2.default.createElement(
                    "span",
                    {
                        id: fieldId,
                        className: "form-control-plaintext"
                    },
                    (0, _GlobalConfig.resolveStaticRenderer)(fieldContext.fieldType)(fieldValue)
                    ...
                    autoFocus: autoFocus,
                    disabled: mode === _FieldMode2.default.DISABLED,
                    readOnly: mode === _FieldMode2.default.READ_ONLY
                })
            );
