...
var FormSelector = function (_React$Component) {
    ...
    function FormSelector() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormSelector.__proto__ || Object.getPrototypeOf(FormSelector)).call.apply(_ref, [this].concat(args))), _this), _this.state = FormSelector.getDerivedStateFromProps(_this.props), _this.selectRow = function (index) {
    ...
    _createClass(FormSelector, [{
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
            var selectedFromProps = nextProps.selectedIndex;
            if (!prevState || selectedFromProps !== prevState.selectedFromProps) {
                return {
                    selectedFromProps: selectedFromProps,
...
FormSelector.propTypes = _extends({
     ...
     * of a given object.
     */
    selector: _propTypes2.default.oneOfType([
