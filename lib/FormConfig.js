    ...
    _createClass(FormConfig, [{
        ...
        value: function equals(other) {
            if (other instanceof FormConfig) {
                if (this.schema !== other.schema || this.type !== other.type || this.basePath !== other.basePath || this.errors !== other.errors ||
        ...
        value: function getValue(path) {
            ...
            if (errorMessages.length > 0) {
                ...
                return (0, _lodash2.default)(this.value, path);
            }
        }
    }, {
        key: "handleChange",
        value: function handleChange(fieldType, name, value) {
            ...
            var error = _InputSchema2.default.validate(fieldType, value);
            var converted = void 0;
            if (error) {
                errorsForField = [value, error];
            } else {
                converted = _InputSchema2.default.valueToScalar(fieldType, value);
            }
            ...
            if (!errorsForField) {
                (0, _lodash4.default)(this.value, name, converted);
            }
